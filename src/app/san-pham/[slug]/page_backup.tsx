      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            {/* Left Column - Thành phần, Hướng dẫn sử dụng, Hướng dẫn bảo quản */}
            <div className="space-y-8">
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-xl border border-emerald-100">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold font-montserrat text-gray-800">Thành phần</h3>
                </div>
                <p className="text-gray-700 font-merriweather leading-relaxed">
                  {product.ingredients || "Gạo tết Việt Nam, nuớc sạch, không chất bảo quản"}
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-6 rounded-xl border border-amber-100">
                ...
                <div className="text-gray-700 font-merriweather space-y-2 leading-relaxed">
                  {product.usage.length > 0 ? (
                    ...
                    <p>• Nấu với nước sôi trong 3-5 phút</p>
                  )}
                </div>
              </div>
            ...
            {/* Center Column - Hình ảnh */}
            <div className="flex justify-center items-center">
              <Carousel className="w-full max-w-xs">
                <CarouselContent>
                  {[getImageByType("product_front"), getImageByType("product_back")].map(
                    (img, index) => (
                      <CarouselItem key={index}>
                        <Card>
                          <CardContent className="flex aspect-square items-center justify-center">
                            <FadeInImage
                              src={img}
                              alt={`${product.name} Package ${index + 1}`}
                              fill={true}
            ...
            {/* Right Column - Sản phẩm an toàn, Đạt chuẩn, Chứng nhận */}
            <div className="space-y-8">
